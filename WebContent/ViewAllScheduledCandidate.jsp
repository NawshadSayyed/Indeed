				...
				<div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">
					<div class="box box-info">
						<div class="box-header">
							...
							<div class="row">
								<form action="./ViewAllScheduledCandidate.jsp" method="post">
										...
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon"> <i
													...
													required="required"
									title="Enter Enter Serch Value"
									oninvalid="setCustomValidity('Please Enter Serch Value')"
